...
import com.mt.library.imagepicker.adapter.ImagePreViewAdapter;
...
import com.mt.library.imagepicker.provider.ImagePickerProvider;
import com.mt.library.imagepicker.utils.DataUtil;
import com.mt.library.imagepicker.view.HackyViewPager;
...
public class ImagePreActivity extends BaseActivity {
            ...
            public void onClick(View v) {
                ...
                if (ConfigManager.getInstance().isSingleType()) {
                    ...
                    if (!selectPathList.isEmpty()) {
                        //判断选中集合中第一项是否为视频
                        if (!SelectionManager.isCanAddSelectionPaths(mMediaFileList.get(mViewPager.getCurrentItem()).getPath(), selectPathList.get(0).getPath())) {
                            //类型不同
     ...
     * 更新选择按钮状态
     */
    private void updateSelectButton(MediaFile imagePath) {
