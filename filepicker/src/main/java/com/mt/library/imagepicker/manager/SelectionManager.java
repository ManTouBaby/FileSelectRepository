package com.mt.library.imagepicker.manager;
...
public class SelectionManager {
     ...
     * @return
     */
    public boolean addImageToSelectList(MediaFile imagePath) {
     ...
     * @param imagePaths
     */
    public void addImagePathsToSelectList(List<MediaFile> imagePaths) {
        if (imagePaths != null) {
            for (int i = 0; i < imagePaths.size(); i++) {
                MediaFile imagePath = imagePaths.get(i);
